...
description: >
  Component owner for apex-fuzz, apex-symbolic, apex-concolic — dynamic path exploration via fuzzing, symbolic/concolic execution, and constraint solving.
  Use when modifying the fuzzing engine, coverage-guided search, SMT solving, or grammar-based mutation.

  <example>
  user: "improve the coverage-guided search strategy"
  assistant: "I'll use the apex-crew-exploration agent — it owns apex-fuzz and the coverage-guided search algorithms."
  </example>

  <example>
  user: "add concolic support for Python conditionals"
  assistant: "I'll use the apex-crew-exploration agent — it owns apex-concolic including the Python condition handler."
  </example>

  <example>
  user: "fix the Thompson sampling scheduler"
  assistant: "I'll use the apex-crew-exploration agent — it owns the fuzzing scheduler in apex-fuzz including Thompson sampling."
  </example>
---
...
schema_version: 1
name: exploration
domain: "Dynamic path exploration — fuzzing engine, symbolic/concolic execution, constraint solving, coverage-guided search"
...
notes: >
  Performance-critical crew. Contains optional heavy dependencies (z3, libafl)
  behind feature flags. Benchmark regression checks recommended.
```
